<?php
namespace ViComm\PaymentGateway\Controller\PlaceOrder;
...
use ViComm\PaymentGateway\Controller\AbstractController;
...
{
    const LTP_PATH = "gpvicomm.com/linktopay/init_order/";
    /**
