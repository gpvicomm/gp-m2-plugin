...
define(
    [
        ...
        'mage/translate',
        'https://cdn.gpvicomm.com/ccapi/sdk/payment_stable.min.js?no_cache=' + Math.random().toString(36).substring(7),
    ],
    function (Component, quote, customer, fullScreenLoader, totals, messageList, $t) {
        ...
        return Component.extend({
            defaults: {
                template: 'ViComm_PaymentGateway/payment/vicomm_card',
                installment: '',
                installment_type: ''
            },
            ...
            initPayment: function () {
                ...
                try {
                    jQuery(document).ready(function () {
                        ...
                        let card_form = jQuery('#vicomm_sdk_form');
